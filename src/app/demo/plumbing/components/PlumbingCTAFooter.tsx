...
export default function PlumbingCTAFooter() {
  return (
    <section className="py-20 px-8 relative overflow-hidden bg-[#7E5700]">
      ...
      <div className="absolute inset-0 opacity-10 flex flex-wrap gap-20 p-10 pointer-events-none">
        ...
        <span className="material-symbols-outlined text-9xl absolute right-20 bottom-0">
          local_florist
        </span>
      </div>
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center">
          <button
            className="bg-[#011545] text-white px-10 py-5 rounded-lg font-bold uppercase tracking-widest hover:scale-[1.05] transition-transform duration-300 shadow-xl"
            style={{ fontFamily: "var(--font-manrope)" }}
          >
            Call Now
          </button>
