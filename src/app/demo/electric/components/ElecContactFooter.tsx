...
export default function ElecContactFooter() {
  return (
    <footer className="bg-[#151c27] text-slate-400 py-12 px-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-lg font-bold text-white" style={{ fontFamily: "var(--font-inter-elec)" }}>POWERLINE ELECTRIC</span>
        </div>
        <p className="text-xs uppercase tracking-widest" style={{ fontFamily: "var(--font-mono-elec)" }}>&copy; {new Date().getFullYear()} POWERLINE ELECTRIC. ALL RIGHTS RESERVED.</p>
      </div>
      ...
      <div className="text-right">
        <p className="text-[#eab308] font-black text-lg" style={{ fontFamily: "var(--font-mono-elec)" }}>(800) 555-8658</p>
