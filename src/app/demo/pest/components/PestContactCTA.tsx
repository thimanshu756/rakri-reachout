"use client";
export default function PestContactCTA() {
  return (
    <section className="px-6 py-20 bg-[#f0fdf4]">
      <div className="max-w-5xl mx-auto rounded-[40px] bg-[#22c55e] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl shadow-[#22c55e]/30">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
          ...
          <button className="px-10 py-5 bg-[#006e2f]/20 text-white border border-white/30 font-extrabold rounded-full backdrop-blur-sm hover:bg-[#006e2f]/30 transition-all active:scale-95" style={{ fontFamily: "var(--font-jakarta)" }}>Call (800) GREEN-01</button>
        </div>
      </div>
    </section>
  );
